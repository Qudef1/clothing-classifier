...
data = pd.read_csv("E:\\clothing-classifier\\data\\Churn_Modelling.csv")

data["Gender"] = data["Gender"].map({"Male":0,"Female":1})
data["Geography"] = data["Geography"].map({"Spain":0,"France":1,"Germany":2})

data = data[["Gender","Tenure","CreditScore","Balance","IsActiveMember","EstimatedSalary","NumOfProducts","Exited"]].dropna()
data["BalancePerProduct"] = data["Balance"]/data["NumOfProducts"]

X = data[["Gender","Tenure","CreditScore","Balance","IsActiveMember","EstimatedSalary","NumOfProducts","BalancePerProduct"]]
Y = data[["Exited"]]
